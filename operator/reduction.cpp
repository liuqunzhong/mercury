...
static int reduction_op(const Tensor<float>& a, Tensor<float>& b, float v0, int dim, float coeff)
{
    Op op;
    Op2 op2;
	/*
...
int Reduction::forward(const Tensor<float>& bottom_blob, Tensor<float>& top_blob) const
{
	/*
